<template>
  <q-page class="bg-grey-3 column">
    <div class="row q-pa-sm bg-primary">
      <q-input v-model="newTask" @keyup.enter="addTask" class="col" square filled bg-color="white" placeholder="Add task"
        dense>
...
export default defineComponent({
  data() { return { newTask: '', tasks: [{ title: 'Dummy task', done: false }] } },
  methods: {
